...
export default function App() {
  ...
  const stockElements = currentData.map((stock) => {
    return <Stock key={stock.stockName} stock={stock} currentData={stock.currentData} logo={stock.logo}  prevClosingPrice={stock.prevClosingPrice} stockName={stock.stockName} />
  })
